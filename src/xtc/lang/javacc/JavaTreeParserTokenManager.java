/* Generated By:JavaCC: Do not edit this line. JavaTreeParserTokenManager.java */
package xtc.lang.javacc;
import xtc.lang.javacc.syntaxtree.*;
import java.util.Vector;

public class JavaTreeParserTokenManager implements JavaTreeParserConstants
{
...
public JavaTreeParserTokenManager(JavaCharStream stream){
   if (JavaCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public JavaTreeParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
