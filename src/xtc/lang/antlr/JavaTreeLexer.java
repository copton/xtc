// $ANTLR 2.7.5 (20050128): "javatree.g" -> "JavaTreeLexer.java"$
...
public class JavaTreeLexer extends antlr.CharScanner implements JavaTreeTokenTypes, TokenStream
 {
public JavaTreeLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public JavaTreeLexer(Reader in) {
	this(new CharBuffer(in));
}
public JavaTreeLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public JavaTreeLexer(LexerSharedInputState state) {
	super(state);
