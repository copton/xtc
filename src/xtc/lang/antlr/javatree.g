 ...
 */
class JavaTreeRecognizer extends Parser;
options {
	k = 2;                           // two token lookahead
	exportVocab=JavaTree;            // Call its vocabulary "Java"
...
// The Java scanner
//----------------------------------------------------------------------------
class JavaTreeLexer extends Lexer;

options {
	exportVocab=JavaTree;      // call the vocabulary "Java"
