...
public class C extends Tool {
  ...
  public void init() {
    ...
    runtime.
      ...
      bool("typical", "optionTypical", false,
           "Use the Typical-generated analyzer.").
  ...
  public void prepare() {
    ...
    if (runtime.test("optionTypical")) {
      if (! runtime.test("optionAnalyze")) {
        runtime.error("typical option requires analyze option");
      }
    }
  ...
  public void process(Node node) {
    ...
    if (runtime.test("optionAnalyze")) {
      ...
      if (runtime.test("optionTypical")) {
        // Analyze and fill in the symbol table.
        table = new xtc.lang.c.CAnalyzer(runtime).run(node);
